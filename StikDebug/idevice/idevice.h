 ...
 */
typedef struct RemoteControlClientHandle RemoteControlClientHandle;
 ...
 */
struct IdeviceFfiError *remote_control_client_next_video_access_unit(struct RemoteControlClientHandle *handle,
                                                                     uint64_t timeout_ms,
                                                                     uint8_t **out_data,
                                                                     uintptr_t *out_len,
 ...
 */
struct IdeviceFfiError *remote_control_client_tap(struct RemoteControlClientHandle *handle,
                                                  uint16_t x,
                                                  uint16_t y);
 ...
 */
struct IdeviceFfiError *remote_control_client_drag(struct RemoteControlClientHandle *handle,
                                                   uint16_t start_x,
                                                   uint16_t start_y,
                                                   uint16_t end_x,
                                                   uint16_t end_y,
 ...
 */
struct IdeviceFfiError *remote_control_client_press_button(struct RemoteControlClientHandle *handle,
                                                           uint8_t button);

/**
 * Stops screen sharing and frees the remote-control clients.
 */
void remote_control_client_free(struct RemoteControlClientHandle *handle);

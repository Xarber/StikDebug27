...
private func backupProgress(_ done: UInt64, _ total: UInt64, _ progress: Double, _ context: UnsafeMutableRawPointer?) {
    backupDelegate(from: context)?.reportProgress(bytesDone: done, bytesTotal: total, fraction: progress)
}
